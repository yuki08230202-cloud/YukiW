...
| 10 日 | ★★ | 「ぴょこっと二桁ヒヨコ」 | 同上+プロフィールにバッジ常設。ここで**マスコットのヒヨコが誕生**し、以降の節目で成長していく |
| 14 / 21 日 | ★★ | 「すくすくコッコ」「はばたきニワトリ」 | ヒヨコ→ニワトリへの成長アニメーション+習慣形成の科学(21 日説)に触れる称賛メッセージ |
| 30 日 | ★★★ | 「皆勤コケコッコー!」 | 最大演出:日の出ムービー+30 日分の写真がモザイクアートに合成される特別カード(保存・共有可)。ニワトリが朝日に向かって高らかに鳴く |
| 50 / 100 日 | ★★★ | 「朝のぬし・オオトリさま」「めざめのフェニックス」 | 100 日でマスコットが🔥の不死鳥に進化(ストリークの炎アイコンと世界観が接続)。アプリアイコン変更権(内発的報酬の最高峰)を解放 |
| 以降 50 日毎 | ★★★ | フェニックスの色進化(150 日=金色、200 日=虹色、…)+日数刻印 | キャラクターの色・オーラが進化し続ける。演出はポップさを保ちつつ、文言は簡潔に |

**称号のトーン設計:** 3〜7 日の「バスター」「ランナー」路線に合わせ、10 日以降は**ヒヨコ→ニワトリ→オオトリ→フェニックス**というマスコットの成長物語として一本化。朝を告げる鳥のモチーフはアプリの世界観と自然につながり、各称号にキャラクターイラストを添えてバッジ・演出・グッズ的展開(スタンプ絵柄など)へ広げられる。

**キャラクターのアートディレクション(「悪口診断」16 タイプ風):**
- ビジュアル:きれいに整った 3D マスコットではなく、**太めのラフな手描き線画・ベタ塗り・無表情〜ジト目のシュールな脱力系**。かわいいのに雑に見える"ゆるさ"がアイデンティティ
- 佇まい:寝癖のついたヒヨコ、半目で立ち尽くすニワトリなど、**「本人も眠い」感を出す**ことで早起きの共感を誘う。荘厳・熱血にしない
- 文言との組み合わせ:キャラは脱力しているのに文言はちゃんと褒めてくる、というギャップを狙う(例:半目のヒヨコ+「二桁とか、正直すごいと思ってる。」)。※悪口診断と違い**毒はユーザーに向けない**(「失敗に優しい」の設計原則を厳守。ツッコミの矛先は常にキャラ自身や"布団"などに向ける)
